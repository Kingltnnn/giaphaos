            ...
            <div className="absolute top-3 right-3 sm:top-4 sm:right-4 z-20 flex items-center gap-1.5">
              {isEditing ? (
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-3 py-1.5 bg-stone-100/80 text-stone-700 rounded-full hover:bg-stone-200 font-bold text-xs shadow-sm border border-stone-200/50 transition-colors"
                >
                ...
                person && (
                  <>
                    <Link
                      ...
                      className="flex items-center gap-1 px-3 py-1.5 bg-amber-100/80 text-amber-800 rounded-full hover:bg-amber-200 font-bold text-xs shadow-sm border border-amber-200/50 transition-colors"
                    >
              ...
              <button
                onClick={closeModal}
                className="size-8 flex items-center justify-center bg-stone-100/80 text-stone-600 rounded-full hover:bg-stone-200 hover:text-stone-900 shadow-sm border border-stone-200/50 transition-colors"
                aria-label="Đóng"
              >
                <X className="size-4" />
              </button>
