  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-1.5 pl-1.5 pr-2.5 py-1 rounded-full hover:bg-stone-100 transition-all duration-200 border border-transparent hover:border-stone-200"
      >
        <div className="size-6 rounded-full bg-linear-to-br from-amber-200 to-amber-100 text-amber-800 flex items-center justify-center text-[10px] font-bold shadow-sm ring-1 ring-amber-300/50">
          {userEmail ? (
        ...
        <ChevronDown
          className={`size-3 text-stone-500 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
